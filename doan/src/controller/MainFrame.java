...
public class MainFrame extends JFrame implements ActionListener, Runnable {
	...
	private JPanel createGraphicsPanel() {
		...
		progressTime = new JProgressBar(0, 1);
		...
		panelControl.add(btnNewGame = createButton("Làm Mới"),
		...
		JPanel panel = new JPanel(new BorderLayout());
		panel.setBorder(new TitledBorder("Chúc may mắn"));
	...
	public void actionPerformed(ActionEvent e) {
            if (e.getSource() == btnNewGame) {
			             ...
			             showDialogNewGame("Bạn vẫn còn trong game. Bạn có muốn chơi màn mới?", "Cảnh Báo",0);
		}
	}
	...
	public void run() {
			...
			progressTime.setValue((int) ((double) time / MAX_TIME * 10));
		}
	}
